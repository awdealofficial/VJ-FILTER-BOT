...
PICS = (environ.get('PICS', 'https://envs.sh/wN-.jpg')).split() #SAMPLE PIC
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002203919072 -1001631972698 -1002194098266').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001631972698') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002147645726')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001800683868')).split()]
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Hollywood_in_HindiHD') # owner username without @
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/hindi_movie_up')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Hollywood_in_HindiHD')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'hindi_movie_up') # Support Chat Link Without https:// or @
